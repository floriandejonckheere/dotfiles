...
plugins=(1password asdf aliases branch brew bundler colorize cp docker docker-compose git github gitignore gpg-agent history iterm2 kubectl macos rails rake rbenv ruby ssh-agent zsh-autosuggestions)
...
alias purr='pnpm --recursive update && pnpm dedupe'
