...
plugins=(1password aliases asdf branch brew bundler colorize cp docker docker-compose git github gitignore gpg-agent history iterm2 kubectl macos rails rake ruby ssh-agent zsh-autosuggestions)
